...
class SelectDistrictUseCase @Inject constructor(
    private val districtRepository: DistrictRepository
) {
    operator fun invoke(latitude: Double, longitude: Double) = districtRepository.getDistrict(latitude, longitude).resultFlow
}